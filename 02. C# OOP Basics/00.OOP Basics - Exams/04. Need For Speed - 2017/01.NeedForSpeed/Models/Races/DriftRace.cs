...
public class DriftRace : Race
{
    ...
    public override void Start()
    {
        ...
        Dictionary<int, Car> orderedParticipants = this.Participants.OrderByDescending(x => x.Value.GetSuspensionPerformance()).ToDictionary(x => x.Key, x => x.Value);
    ...
    protected override string GetWinningStats()
    {
        ...
        foreach (Car winner in this.Winners)
        {
            ...
            sb.AppendLine($"{place}. {winner.Brand} {winner.Model} {winner.GetSuspensionPerformance()}PP - ${price}");
