namespace FourFlagsRPG.Models.Models.Quests
{
    ...
    {
        private const string NotNullOrEmpty = "String cannot be Null or Empty";
        private const string NotZeroOrNegative = "Value cannot be Zero or Negative";
        ...
        public string ShowRewards()
        {
            ...
            result.AppendLine($"You have gained: {this.ExperienceReward} Experience Points!");
            result.AppendLine("You have collected:");
