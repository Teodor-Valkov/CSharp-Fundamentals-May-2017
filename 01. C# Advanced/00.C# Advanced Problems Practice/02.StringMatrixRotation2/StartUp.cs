namespace _02.StringMatrixRotation2
{
    using System;
    ...
    internal class StartUp
    {
        ...
        private static void Main()
        {
            ...
            {
                case 0:
                    result = RotateOn360Degree(input, longestWordLength);
                    PrintMatrix(result);
                    break;

                case 1:
                    result = RotateOn90Degree(input, longestWordLength);
                    PrintMatrix(result);
                    break;

                case 2:
                    result = RotateOn180Degree(input, longestWordLength);
                    PrintMatrix(result);
                    break;

                case 3:
                    result = RotateOn270Degree(input, longestWordLength);
                    PrintMatrix(result);
                    break;
            }
        }

        private static char[,] RotateOn90Degree(List<string> input, int longestWordLength)
        {
        ...
        private static char[,] RotateOn180Degree(List<string> input, int longestWordLength)
        {
        ...
        private static char[,] RotateOn270Degree(List<string> input, int longestWordLength)
        {
            int rows = longestWordLength;
            int cols = input.Count;
            char[,] matrix = new char[rows, cols];
        ...
        private static char[,] RotateOn360Degree(List<string> input, int longestWordLength)
        {
            int rows = input.Count;
            int cols = longestWordLength;
            char[,] matrix = new char[rows, cols];
