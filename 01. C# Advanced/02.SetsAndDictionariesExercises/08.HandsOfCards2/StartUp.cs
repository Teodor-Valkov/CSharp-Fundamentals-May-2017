namespace _08.HandsOfCards2
{
    ...
    internal class StartUp
    {
        private static void Main()
        {
            ...
            while ((input = Console.ReadLine()).ToLower() != "joker")
            {
            ...
            PrintResult(nameAndCards);
        }

        private static void PrintResult(Dictionary<string, HashSet<string>> nameAndCards)
        {
