...
public class HeroInventory : IInventory
{
    ...
    public void CombineRecipe(IRecipe recipe)
    {
        ...
        IItem item = new CommonItem(recipe.Name, recipe.StrengthBonus, recipe.AgilityBonus, recipe.IntelligenceBonus, recipe.HitPointsBonus, recipe.DamageBonus);
