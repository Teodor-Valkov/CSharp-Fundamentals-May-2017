...
namespace SoftUniInjector.Repositories
{
    ...
    [InjectionCandidate]
    public class DefaultUserRepository : IUserRepository, INeshtoSiInterface
    {
        private readonly IPaymentsRepository paymentsRepo;

        private readonly ISoftUniRepository softUniRepo;

        private int count;

        public DefaultUserRepository(IPaymentsRepository paymentsRepo, int count, ISoftUniRepository softUniRepo)
        {
